...
impl PoERNode {
    ...
    pub fn choose_leader(state: &mut PbftState) -> Vec<u8>{
        ...
        let name_to_key: BTreeMap<&str, &str> = [
            ...
            ("pbft2pub", "NODE_2_PUB_KEY"),
            ("pbft3pub", "NODE_3_PUB_KEY"),
            ("pbft4pub", "NODE_4_PUB_KEY"),
        ].iter().cloned().collect();

        let key_to_name: BTreeMap<&str, &str> = [
            ("NODE_0_PUB_KEY", "pbft0pub"),
            ("NODE_1_PUB_KEY", "pbft1pub"),
            ("NODE_2_PUB_KEY", "pbft2pub"),
            ("NODE_3_PUB_KEY", "pbft3pub"),
